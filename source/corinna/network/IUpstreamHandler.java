...
public interface IUpstreamHandler extends ChannelUpstreamHandler
{
	...
	public void incomingException( final ChannelHandlerContext context, final ExceptionEvent event )
		throws Exception;
}
