...
/**
 * Disparada quando uma implementação de servidor deseja precisa iniciar em modo de instalação. 
 * Esta exceção é representada pelo valor inteiro 0x90.
 * 
 * @author Bruno Ribeiro &lt;brunoc@cpqd.com.br&gt;
 * @since 1.2
 */
public class InstallModeException extends GenericException
{
	
	/**
	 * Identificador único para serialização.
	 */
	private static final long serialVersionUID = -591685410161593055L;
	
	/**
	 * Código numérico que representa a exceção.
	 */
	private static final int ERROR_CODE = 0x90;

	
	/**
	 * Constroi uma exceção sem uma descrição.
	 */
	public InstallModeException() 
	{
		super();
	}
	 ...
	 */
	public InstallModeException( String message, Throwable cause ) 
	{
		super(message, cause);
	}
	 ...
	 * @param cause Referência ao objeto <code>Throwable</code> que causou a exceção.
	 */
	public InstallModeException( Throwable cause ) 
	{
		super(cause);
	}
	 ...
	 * @param message Descrição da exceção.
	 */
	public InstallModeException( String message ) 
	{
		super(message);
	}
