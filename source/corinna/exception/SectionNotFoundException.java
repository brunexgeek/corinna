...
/**
 * Disparada quando solicitada uma seção que não existe na configuração. Esta exceção é 
 * representada pelo valor inteiro 0x42.
 * 
 * @author Bruno Ribeiro &lt;brunoc@cpqd.com.br&gt;
 * @since 1.0
 */
public class SectionNotFoundException extends ConfigurationException 
{

	/**
	 * Identificador único para serialização.
	 */
	private static final long serialVersionUID = 6933865436668731768L;

	/**
	 * Código numérico que representa a exceção.
	 */
	private static final int ERROR_CODE = 0x42;
