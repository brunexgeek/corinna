...
/**
 * Implementations of this interface receive notifications about changes to the servlet context of
 * the web application they are part of. To receive notification events, the implementation class
 * must be configured in the deployment descriptor for the web application.
 * 
 * @see BindletContextEvent
 * @since v 2.3
 */

public interface IBindletContextListener extends EventListener
{
	 ...
	 */
	public void contextInitialized( IBindletContext context );
	 ...
	 */
	public void contextDestroyed( IBindletContext context );
